...
from src.schemas.book_schemas import Book, BookCreateModel, BookDetailModel, BookUpdateModel
from src.utils.error_handling import BookNotFound
...
async def delete_a_book(book_uid: str, session: AsyncSession = Depends(get_session), token_details: dict = Depends(access_token_bearer)):
